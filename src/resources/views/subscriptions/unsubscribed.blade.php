	...
	<div class="container">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h2>Subscription Details <small class="label label-{{ $subscription->status == 1 ? 'success' : 'danger' }} pull-right">{{ config('subscription.enum.status')[$subscription->status] }}</small></h2>
			</div>
