  ...
  <div class="panel panel-default">
    <div class="panel-body">
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          {!! Form::select('status', config('subscription.enum.status'), null, ['class' => 'form-control']) !!}
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          {!! Form::select('type', config('subscription.enum.type'), null, ['class' => 'form-control']) !!}
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          {!! Form::select('duration', config('subscription.enum.duration'), null, ['class' => 'form-control']) !!}
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          ...
          <a href="{{ url('/subscriptions') }}" class="btn btn-danger">Cancel</a>
        </div>
      </div>
